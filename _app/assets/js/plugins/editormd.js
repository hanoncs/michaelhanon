...
;(function (factory) {
    ...
    editormd.defaults = {
        ...
        width: "100%",
        height: "100%",
        path: "/_app/assets/js/plugins/editor/",       // Dependents module file directory
        pluginPath: "/_app/assets/js/plugins/editor/plugins/",             // If this empty, default use settings.path + "../plugins/"
